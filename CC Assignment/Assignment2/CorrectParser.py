...
Grammer according to Muhammad Shafay Amjad 454-BSCS-13 E-2 , C.R
   expr --> term Rest
   Rest --> +term {print ('+')}Rest | - term{print ('-')} Rest | *term{print ('*')} Rest | /term {print ('/')}Rest | NULL
   term --> 0 print (0) and so on
   term--> factor Rest
   Rest-->*factor Rest | /factor Rest | NULL
   '''
